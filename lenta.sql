...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 03 2022 г., 21:42
...
CREATE TABLE `data` (
  `id` int NOT NULL,
  `title` varchar(71) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lid` varchar(180) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `content` varchar(1460) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `rubricId` int NOT NULL,
  `image` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
